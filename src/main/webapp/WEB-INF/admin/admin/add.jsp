    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          ...
          <form action="${base}/admin/doAdd" id="myForm" onsubmit="return checkForm()" method="post" enctype="multipart/form-data" class="row">
            ...
            <div class="form-group col-md-12">
              ...
              <div class="clearfix">
                <label class="lyear-radio radio-inline radio-primary">
                  <input type="radio" name="status" value="0"><span>未验证</span>
                </label>
                <label class="lyear-radio radio-inline radio-primary">
                  <input type="radio" name="status" value="1" checked><span>正常</span>
                </label>
                <label class="lyear-radio radio-inline radio-primary">
                  <input type="radio" name="status" value="2"><span>注销</span>
                </label>
              </div>
            </div>
              ...
              <div class="form-controls">
                ...
                <ul class="list-inline clearfix lyear-uploads-pic">
                  <li class="col-xs-4 col-sm-3 col-md-2">
                    <figure>
                      <img src="../images/gallery/15.jpg" alt="图片一" id="MyImg">
                      <figcaption>
...
<script>
  ...
  function checkAccount(){
    var account = document.getElementById("name").value;
    $.post('${base}/admin/checkAccount?account='+account,function (result) {
      if (result=="账号可用"){
        lightyear.loading('show');
        // 假设ajax提交操作
        setTimeout(function() {
